...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/f6e3f5a378e34cd5ba8c11d432c399eb?v=c039728cc6504c72b917b84a6654965e&pvs=4
  NOTION_PAGE_ID:
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'IMyself', // 您的昵称 例如 IMyself
  BIO: process.env.NEXT_PUBLIC_BIO || '前端小萌新~', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.lmyself.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'IMyself, shadownc,博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Shadownc', // 你的github个人主页 例如 https://github.com/Shadownc
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/Y_IMyself
  ...
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
    ...
    //TAWK
  TAWK_ID: process.env.NEXT_PUBLIC_TAWK_ID || '', // https://tawk.to/
...
//   PRISM_THEME_LIGHT_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-solarizedlight.css', // 浅色模式主题
  PRISM_THEME_LIGHT_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-base16-ateliersulphurpool.light.css',
  ...
  PREVIEW_CATEGORY_COUNT: 17, // 首页最多展示的分类数量，0为不限制
  ...
  WIDGET_PET_LINK:
        ...
        'https://raw.githubusercontent.com/imuncle/live2d/master/model/Tia/index.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  COMMENT_UTTERRANCES_REPO:
        process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || '', // 你的代码仓库名， 例如我是 'Shadownc/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || '', // 你的Github仓库名 e.g 'Shadownc/NotionNext'
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || '', // 你的用户名 e.g Shadownc
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || '', // 管理员用户名、一般是自己 e.g 'Shadownc'
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '7944608350', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '2883853366', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '7944608350', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '8710895112', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'IMyself', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '前端技术分享记录~', // 站点描述，被notion中的页面描述覆盖
  // ANIMATE.css 动画
  ANIMATE_CSS_URL:
